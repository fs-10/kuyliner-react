            ...
            <div class='w-full self-end px-6 ml-18 sm:px-40 sm:pt-7'>
              <div class='mb-8 w-full px-4 '>
                ...
                <input
                  type='text'
                  id='userName'
                  class='w-full rounded-md bg-slate-50 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary' placeholder="masukan username" required
                        aria-describedby="user name" name="user name"
                />
              </div>
              <div class='mb-8 w-full px-4'>
                ...
                <input
                  type='email'
                  id='email'
                  class='w-full rounded-md bg-slate-50 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary' placeholder="example@email.com" required
              ...
              <div class='mb-8 w-full px-4'>
                ...
                <input
                  type='password'
                  id='password'
                  class='w-full rounded-md bg-slate-50 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary' placeholder="Masukan password" required
                        aria-describedby="password" name="password"
                ></input>
              </div>
              <div class='mb-8 w-full px-4'>
                <label for='konfirmasiPassword' class='text-base font-bold text-primary'>
                  Konfirmasi Password
                </label>
                <input
                  type='password'
                  id='konfirmasiPassword'
                  class='w-full rounded-md bg-slate-50 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary' placeholder="Masukan konfirmasi password" required aria-describedby="konfirmasi password"
                        name="konfirmasi password"
                ></input>
              </div>
              <div className="rounded-full border-solid border-2 border-yellow-300 p-3 flex flex-row gap-20 items-center justify-center flex-shrink-0 w-50 h-12 relative overflow-hidden mb-5 mt-2">
                <a
                  href='#'
                  className='rounded-sm  px-5 py-1 font-bold text-xl'
                >
                  Submit
                </a>
              </div>
